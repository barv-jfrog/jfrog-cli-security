...
func TestBuildSwiftDependencyList(t *testing.T) {
	...
	expectedUniqueDeps := []string{
		...
		techutils.Swift.GetPackageTypeId() + "github.com/apple/swift-http-types:1.3.0",
...
func TestFixTechDependencySingleLocation_Range(t *testing.T) {
	testCases := []struct {
		...
		{testName: "TestSingleLocation_Exact", dependencyName: "github.com/apple/swift-http-types", dependencyVersion: "1.3.0", fixVersion: "1.3.1", stringToFind: ".package(url: \"https://github.com/apple/swift-http-types\", exact: \"1.3.1\""},
